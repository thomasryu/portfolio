...
export const gallery: Image[] = [
  ...
  {
    src: '/images/gallery/iii.jpg',
    alt: 'A portrait of black-haired lady wearing a pitch-black dress. Adorning her are a set of robust pauldrons and gorget.',
    size: {
      width: 2700,
      height: 4800,
    },
  ...
  {
    src: '/images/gallery/cactus.png',
    alt: 'A drawing of pink flower blooming on a cactus',
    size: {
      width: 1500,
      height: 2000,
    },
  ...
  {
    src: '/images/gallery/hand-in-hand.png',
    alt: 'A 3D model of a box of playing cards with "Hand in Hand" writen on it. Around it, various illustrations of hands, flowers and snakes.',
    size: {
      width: 1920,
      height: 1920,
    },
